...
MAX_EPOCH = 150
sequenceLength = 3
setup_name = "ucf_simple_vgg16_seq3_convlstm_c5"
UCF_CLASS_LIMIT = 5
BATCHSIZE = 5
MODE = "train"
...
def main(mode=MODE,num_epochs=MAX_EPOCH):
    ...
    # x = TimeDistributed(Conv2D(64, (3, 3), padding='same', activation='relu', name='block6_conv1'))(x)
    ...
    print(K.int_shape(x))
    x = ConvLSTM2D(filters=100, kernel_size=(3, 3),padding='same', return_sequences=True, name = 'conv_lst_m2d_1')(x)
    ...
    x = ConvLSTM2D(filters=100, kernel_size=(3, 3),padding='same', return_sequences=True, name = 'conv_lst_m2d_2')(x)
