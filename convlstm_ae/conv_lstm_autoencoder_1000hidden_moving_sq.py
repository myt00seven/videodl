...
EPOCH = 5
sequenceLength = 15
setup_name = "conv_80_40_40_lstm_1000"
...
def main(num_epochs=EPOCH):
    ...
    x = TimeDistributed(Conv2D(80, (3, 3), padding='same'), input_shape=(sequenceLength,40,40,1))(inputs)
    ...
    x = LSTM(1000, activation='tanh', return_sequences=True)(x)
    print(K.int_shape(x))

    # x = Reshape((15,10,10,4))(x)
    x = TimeDistributed(Reshape((5,5,40)))(x)
